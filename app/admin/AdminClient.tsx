    ...
    <section className="rm-admin-main">
      <header className={`rm-admin-topbar ${topbarStyles.topbar}`}>
        ...
        <div className={topbarStyles.actions}>
          ...
          {data && <NewOrderNotifier orders={data.orders} restaurantName={data.restaurant.name} />}
