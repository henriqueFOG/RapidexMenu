...
const plans = [
  {name:"Começo",slug:"start",price:"97",desc:"Para organizar o canal próprio e começar a vender direto.",items:["Cardápio, link e QR Code","Gestor de pedidos","Pix e pagamento na entrega","Relatórios essenciais"]},
  {name:"Crescimento",slug:"growth",price:"297",desc:"Para vender no automático e trazer clientes de volta.",featured:true,items:["Tudo do plano Começo","Vendedor IA no WhatsApp","Memória de preferências","Recuperação e recompra","Guardião de margem"]},
  {name:"Escala",slug:"scale",price:"597",desc:"Para operações com mais volume, equipe e unidades.",items:["Tudo do Crescimento","Até 3 unidades","KDS e fila inteligente","Integrações e permissões","Suporte prioritário"]},
];
...
export default function RapidexLanding() {
  ...
  return <main className={styles.landing}>
    <section className={styles.hero} id="inicio">
      <header className={styles.header}>
        ...
        <nav className={menuOpen ? styles.navOpen : ""}>
          ...
          <div className={styles.mobileActions}><a href="/loja/serra-burger">Experimentar em tempo real</a><a href="/entrar">Acessar painel</a></div>
        </nav>
        <div className={styles.headerActions}>
          <a className={styles.liveButton} href="/loja/serra-burger">Experimentar em tempo real</a>
          <a className={styles.panelButton} href="/entrar">Acessar Painel</a>
      ...
      <div className={styles.heroInner}>
        <div className={styles.heroCopy}>
          ...
          <div className={styles.heroCtas}>
            <a className={styles.primaryCta} href="/loja/serra-burger">Experimentar em tempo real <span>→</span></a>
            <a className={styles.secondaryCta} href="/demo/painel"><span className={styles.play}>▣</span> Ver painel funcionando</a>
          </div>
        ...
        <div className={styles.heroVisual}>
          ...
          <a className={styles.phoneLink} href="/loja/serra-burger" aria-label="Experimentar cardápio em tempo real">
    ...
    <section className={styles.finalCta} id="contato"><div><Logo/><h2>Pronto para transformar seu restaurante?</h2><p>Crie seu cardápio online e comece a construir seu canal próprio.</p></div><div className={styles.finalActions}><a href="/cadastro">Começar agora <span>→</span></a><a href="/loja/serra-burger">Experimentar em tempo real</a><a href="/entrar">Acessar painel</a></div></section>
    <footer className={styles.footer}><Logo/><span>© 2026 RapidexMenu. Todos os direitos reservados.</span><nav><a href="#como-funciona">Como funciona</a><a href="#planos">Planos</a><a href="/loja/serra-burger">Experimentar</a><a href="/entrar">Painel</a></nav></footer>
  </main>;
}
